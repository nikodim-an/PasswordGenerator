...
# ередавать - то на текущий. Пароли уникальны.
#
# Эта хрень полностью настраивается. Отбор и формирование пароля происходит из списка points
# все остальное - генерируется уникально. если нужно увеличить сложность пароля, просто 
